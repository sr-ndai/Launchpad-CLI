...
| 8.1 | 8 | Job manifest and task references | revision-needed | — | task/8.1-job-manifest-and-task-refs | Builder |
| 8.2 | 8 | Solver-aware log resolution and selector support | pending | 8.1 | task/8.2-solver-aware-log-resolution | — |
