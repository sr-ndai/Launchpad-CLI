...
| 7.2 | 7 | Guided setup and diagnostics UX | in-progress | 7.1 | task/7.2-guided-setup-and-diagnostics | Codex |
| 7.3 | 7 | Primary workflow terminal experience | ready | 7.1 | task/7.3-primary-workflow-experience | — |
